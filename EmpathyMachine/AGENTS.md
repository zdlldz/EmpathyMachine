...
8. Focus on *Nature — i.e. default to plants, raw elements, and awe/reverence for our world. Keep humans + animals to absolute minimum unless the are truly needed.*
9. There must be identifiable in the frame.

### Camera

1. Fast framerate IMAX camera with 480mm lens. (Extremely long lens!)
2. Camera movement pushes in to the center of frame in mix of fast + ultra slow motion.
